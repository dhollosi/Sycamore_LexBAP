    ...
    *******************************************************************************"""
    ...
    def generate_path(self):
        ...
        if self.goal_pose_x is not None:
            ...
            delta_new = -np.arctan2((self.goal_pose_y - self.last_pose_y),
                                    (self.goal_pose_x - self.last_pose_x)) + self.yaw
            ...
            omega = -(v / r) * (self.k2 * (self.delta - np.arctan(-self.k1 * self.goal_pose_theta)) + (1 + self.k1 / (
                        1 + (self.k1 * self.goal_pose_theta) * (self.k1 * self.goal_pose_theta))) * np.sin(self.delta))
